// 07. 조건렌더링 JSX + 리스트 렌더링 JSX

// 리엑트에서는 조건부로 구성요소를 랜더링 할 수 있다.
...
function WishList(props) { // 전달되는 속성명은 wlist
  ...
  return (
    <React.Fragment>
      ...
      {mycars.length > 0 && (
        <div>
          <h2>내가 사고 싶은 자동차는 모두 {mycars.length}대 입니다.</h2>
          <ul>
            {
...
const cars = ["제네시스", "그랜져", "롤스로이스","테슬라"];
// const cars = [];
const root3 = ReactDOM.createRoot(document.getElementById("root3"));
root3.render(<WishList wlist={cars} />);


// 조금 더 복잡한 속성을 전달하여 반복하는 위시리스트 2
...
// 3. 조건연산자(삼향연산자) 를 사용하여 조건부 렌더링하기
...
root5.render(<React.Fragment><h1>[ ★ 카타르 중계석 ☆ ] </h1><Goal isGoal={false} /></React.Fragment>);

const root6 = ReactDOM.createRoot(document.getElementById("root6"));
root6.render(<React.Fragment><h1>[ ★ 카타르 중계석 ☆ ] </h1><Goal isGoal={true} /></React.Fragment>);
